...
model_path_sc = "C:/Users/TahmasebzadehG/PycharmProjects/InfoRetrieval/resources/scene_classification/resnet50_places365.pth.tar"
hierarchy = "C:/Users/TahmasebzadehG/PycharmProjects/InfoRetrieval/resources/scene_classification/scene_hierarchy_places365.csv"
labels = "C:/Users/TahmasebzadehG/PycharmProjects/InfoRetrieval/resources/scene_classification/categories_places365.txt"
...
# print('Done!')
model_path_scene = "C:/Users/TahmasebzadehG/PycharmProjects/InfoRetrieval/resources/scene_classification/resnet50_places365.pth.tar"
...
# write train data
HDF5_DIR = ROOT_PATH / f'mlm_dataset/hdf5/images/images.h5'
...
with h5py.File(HDF5_DIR, 'a') as h5f:
    for i, id in enumerate(list(img_dict.keys())):
        ...
        location_features = scence_obj.get_img_embedding(img)
        # save values
        h5f.create_dataset(name=f'{id}_images', data=location_features, compression="gzip", compression_opts=9)
